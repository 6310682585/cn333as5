...
private fun mapDialogText(dialog: Int): String = when (dialog) {
    RESTORE_PHONES_DIALOG -> "Are you sure you want to restore selected phones number?"
    PERMANENTLY_DELETE_DIALOG -> "Are you sure you want to delete selected phones number permanently?"
    else -> throw RuntimeException("Dialog not supported: $dialog")
}